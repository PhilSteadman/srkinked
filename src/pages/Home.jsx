    ...
    <div className="home page-enter">
      <section className="hero">
        ...
        <div className="hero-content">
          <div className="hero-tag tag">Bristol's Premier Tattoo Studio</div>
          <h1 className="hero-title"><span className="hero-srj">SRJ</span><span className="hero-inked">INKED</span></h1>
      ...
      <section className="about-strip">
        <div className="about-strip-inner">
          <div className="about-text">
            ...
            <p>Based in Bristol, SRJ Inked specialises in bespoke tattoo art across every style. Every tattoo is designed exclusively for you — from concept to finished piece.</p>
